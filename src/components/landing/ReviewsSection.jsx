      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-block mb-6">
            <div className="flex items-center gap-3 px-6 py-3 bg-gray-50 border-2 border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reviews.map((review, index) => (
            <motion.div
              ...
              className="bg-white border-2 border-gray-200 p-8 hover:border-red-600 transition-all duration-300 hover:shadow-xl"
            >
              {/* Stars */}
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-gray-200">
                ...
                <div>
                  ...
                  <div className="text-xs text-red-600 font-semibold uppercase">{review.project}</div>
                </div>
              </div>
            </motion.div>
          ))}
