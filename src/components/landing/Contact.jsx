      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-2">
            Fill out the form below and we'll contact you within <span className="text-gold-400 font-bold">24 hours</span>
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-gray-900 p-8 rounded-2xl shadow-2xl border border-gray-800 relative overflow-hidden"
          >
            ...
            <div className="mb-6 p-4 bg-gradient-to-r from-gold-500/20 to-gold-500/10 rounded-lg border border-gold-500 relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-transparent transition-all text-white"
                >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {/* Phone */}
              <div className="text-center p-6 bg-gray-900 rounded-xl border border-gray-800 shadow-sm">
              ...
              <div className="text-center p-6 bg-gray-900 rounded-xl border border-gray-800 shadow-sm">
                ...
                <p className="text-gray-300">info@mottaone.com</p>
                <p className="text-sm text-gray-400 mt-1">Response in 24hrs</p>
              </div>
              ...
              <div className="text-center p-6 bg-gray-900 rounded-xl border border-gray-800 shadow-sm">
                ...
                <p className="text-gray-300">123 Stone Avenue</p>
